...
class Character:
    ...
    def weapon_attack(self, target):
        """
        Attack using the character's weapon if they have one.
        """
        if self.weapon:
    ...
    def display_stats(self):
        ...
        print("=" * 30)
        print(f"  Character Stats for: {self.name}")
        print("=" * 30)
        print(f"{'Health:':<12} {self.health}")
        print(f"{'Strength:':<12} {self.strength}")
        print(f"{'Magic:':<12} {self.magic}")
        print(f"{'Weapon:':<12} {self.weapon.name if self.weapon else 'None'}")
        print("=" * 30)
...
class Warrior(Player):
    ...
    def __init__(self, name):
        ...
        super().__init__(name, "Warrior", 120, 15, 5, weapon=None)
    ...
    def attack(self, target):
        ...
        # TODO: Implement warrior-specific abilities (if any)
    ...
    def weapon_attack(self, target):
        """
        Attack using the warrior's weapon if they have one.
        """
        if self.weapon:
            damage = self.strength + self.weapon.damage_bonus
            target.take_damage(damage)
...
class Mage(Player):
    ...
    def __init__(self, name):
        ...
        super().__init__(name, "Mage", 80, 8, 20, weapon=None)
    ...
    def weapon_attack(self, target):
        """
        Attack using the mage's weapon if they have one.
        """
        if self.weapon:
...
class Rogue(Player):
    ...
    def __init__(self, name):
        ...
        super().__init__(name, "Rogue", 90, 12, 10, weapon=None)
    ...
    def weapon_attack(self, target):
        """
        Attack using the rogue's weapon if they have one.
        """
        if self.weapon:
            damage = self.strength + self.weapon.damage_bonus
            target.take_damage(damage)
...
if __name__ == "__main__":
    ...
    # Test polymorphism (same method name, different behavior)
    print("\n Testing Polymorphism (same attack method, different behavior):")
    dummy_target = Character("Target Dummy", 100, 0, 0, weapon=None)

    for character in [warrior, mage, rogue]:
        print(f"\n{character.name} attacks the dummy:")
        character.attack(dummy_target)
        dummy_target.health = 100  # Reset dummy health after each hit

    # Test special abilities
    print("\n Testing Special Abilities:")
    target1 = Character("Enemy1", 50, 0, 0, weapon=None)
    target2 = Character("Enemy2", 50, 0, 0, weapon=None)
    target3 = Character("Enemy3", 50, 0, 0, weapon=None)
